...
# coding: utf-8
"""
validate.py -- copper-ore skill report validator
Usage:
...
def validate_report(report_path):
    ...
    # copper-ore specific: NPV or economic analysis
    econ_ok = any(kw in full_text for kw in ["NPV", "IRR", "经济分析", "economic analysis", "品位", "grade"])
    if not econ_ok:
        issues.append("no economic analysis (NPV/IRR/grade) found -- required for copper reports")
