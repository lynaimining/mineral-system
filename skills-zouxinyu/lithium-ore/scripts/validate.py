...
# coding: utf-8
"""
validate.py -- lithium-ore skill report validator
Usage:
...
def validate_report(report_path):
    ...
    # lithium-ore specific: Mg/Li ratio or brine/pegmatite type distinction
    li_type_ok = any(kw in full_text for kw in [
        "Mg/Li", "伟晶岩", "盐湖", "pegmatite", "brine", "spodumene", "锂辉石", "Li2O", "LCE"
    ])
    if not li_type_ok:
        issues.append("no lithium deposit type indicators found (Mg/Li / 伟晶岩 / 盐湖 / LCE)")
